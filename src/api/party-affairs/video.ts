...
export function pageVideoClassify(req: PageVideoClassifyReq) {
	return axios.get<PageVideoClassifyRes>('/party-affairs/v1/video/classify', { params: req });
}

export function addVideoClassify(data: AddVideoClassifyReq) {
	return axios.post('/party-affairs/v1/video/classify', data);
}

export function updateVideoClassify(data: UpdateVideoClassifyReq) {
	return axios.put('/party-affairs/v1/video/classify', data);
}

export function deleteVideoClassify(id: number) {
	return axios.delete('/party-affairs/v1/video/classify', {
		params: { id }
	});
}

export function pageVideoContent(data: PageVideoContentReq) {
	return axios.get<PageVideoContentRes>('/party-affairs/v1/video/contents', {
		params: { ...data }
	});
}

export function getVideoContent(id: number) {
	return axios.get<VideoContent>('/party-affairs/v1/video/content', {
		params: { id }
	});
}

export function addVideoContent(data: AddVideoContentReq) {
	return axios.post('/party-affairs/v1/video/content', data);
}

export function updateVideoContent(data: UpdateVideoContentReq) {
	return axios.put('/party-affairs/v1/video/content', data);
}

export function deleteVideoContent(id: number) {
	return axios.delete('/party-affairs/v1/video/content', {
		params: { id }
	});
}
