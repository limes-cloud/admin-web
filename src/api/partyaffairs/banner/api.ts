...
export function ListBanner(params: ListBannerRequest) {
	return axios.get<ListBannerReply>('/partyaffairs/api/v1/banners', { params });
}

// CreateBanner 创建轮播信息
export function CreateBanner(data: CreateBannerRequest) {
	return axios.post<CreateBannerReply>('/partyaffairs/api/v1/banner', data);
}
...
export function DeleteBanner(params: DeleteBannerRequest) {
	return axios.delete('/partyaffairs/api/v1/banner', { params });
}
