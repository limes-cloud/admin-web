...
export function ListAuth(params: ListAuthRequest) {
	return axios.get<ListAuthReply>('/application/api/v1/auths', { params });
}

// CreateAuth 创建应用授权信息
export function CreateAuth(data: CreateAuthRequest) {
	return axios.post<CreateAuthReply>('/application/api/v1/auth', data);
}

// UpdateAuthStatus 更新应用授权信息状态
export function UpdateAuthStatus(data: UpdateAuthStatusRequest) {
	return axios.put('/application/api/v1/auth/status', data);
}

// DeleteAuth 删除应用授权信息
export function DeleteAuth(params: DeleteAuthRequest) {
	return axios.delete<DeleteAuthReply>('/application/api/v1/auth', { params });
}
