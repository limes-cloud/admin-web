...
import { Notice, PageNoticeReq } from '@/api/party-affairs/types/notice';
import { addNotice, deleteNotice, getNotice, pageNotice, updateNotice } from '@/api/party-affairs/notice';
