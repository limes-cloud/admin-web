<template>
	<a-row v-permission="'manager:tenantapp:query'">
		<a-col :flex="1">
...
import { ListTenantAppRequest } from '@/api/manager/tenant/type';

const form = ref<ListTenantAppRequest>({} as ListTenantAppRequest);
...
const reset = () => {
	form.value = {} as ListTenantAppRequest;
};
</script>
