<template>
	<a-row v-permission="'manager:feedback:query'">
		<a-col :flex="1">
...
import { ListFeedbackCategory } from '@/api/manager/feedback/api';
import { ListFeedbackRequest } from '@/api/manager/feedback/type';
