		...
		<a-form ref="formRef" :model="form" label-align="left" layout="horizontal" auto-label-width>
			...
			>
				<a-cascader
					...
					:options="[{ id: 0, name: '顶级部门', children: depts }]"
					placeholder="请选择上级部门"
					allow-search
				/>
			</a-form-item>
...
import { CreateDept, ListDeptClassify, UpdateDept } from '@/api/manager/dept/api';
...
const showUpdateDrawer = (data: Dept) => {
	if (data.roles) {
