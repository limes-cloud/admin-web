...
import { Resource, ListResourceRequest } from '@/api/poverty/resource/type';
import { ListResource } from '@/api/poverty/resource/api';
...
//  处理tool按钮新建
const handleToolAdd = () => {
	form.value = { status: false } as Resource;
