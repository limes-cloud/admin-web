		...
		<a-form ref="formRef" :model="form" label-align="left" layout="horizontal" auto-label-width>
			...
			>
				<Upload
					...
					:auto-upload="true"
					:files="files()"
					directory-path="poverty/information"
					accept="image/*"
...
import { CreateInformation, UpdateInformation } from '@/api/poverty/information/api';
import { CreateInformationRequest, UpdateInformationRequest, Information } from '@/api/poverty/information/type';
