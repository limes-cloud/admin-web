		...
		<a-form ref="formRef" :model="form" label-align="left" layout="horizontal" auto-label-width>
			...
			>
				<Upload
					...
					:auto-upload="true"
					:files="files()"
					directory-path="poverty/activity"
					accept="image/*"
...
import { CreateActivity, UpdateActivity } from '@/api/poverty/activity/api';
import { CreateActivityRequest, UpdateActivityRequest, Activity } from '@/api/poverty/activity/type';
