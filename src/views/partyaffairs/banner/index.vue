...
<script setup lang="ts">
  ...
  import { CreateBanner, DeleteBanner, ListBanner, UpdateBanner } from '@/api/partyaffairs/banner/api'
  import { CreateBannerRequest, Banner, UpdateBannerRequest } from '@/api/partyaffairs/banner/type'
  ...
  const formItems = [
    {
      ...
      props: {
        ...
        directoryPath: 'partyaffairs/banner'
      }
    },
    {
      key: 'title',
  ...
  const operationItems = [
    {
      ...
      label: '角色绑定',
      color: 'primary',
      permission: 'partyaffairs:banner:role',
    ...
    },
    {
      ...
      label: '新建轮播图',
      color: 'primary',
      permission: 'partyaffairs:banner:add',
      click: async () => {
        showDialog('add')
      }
    },
    {
      ...
      label: '修改轮播图',
      color: 'warning',
      permission: 'partyaffairs:banner:update',
      click: async (record: Banner) => {
    ...
    },
    {
      ...
      label: '删除轮播图',
      color: 'danger',
      permission: 'partyaffairs:banner:delete',
      click: async (record: Banner) => {
