...
import { NewsClassify, NewsContent, PageNewsContentReq } from '@/api/partyaffairs/types/news';
import { addNewsContent, allNewsClassify, deleteNewsContent, getNewsContent, pageNewsContent, updateNewsContent } from '@/api/partyaffairs/news';
