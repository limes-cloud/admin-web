...
import { pageNews, getNews, addNews, deleteNews, updateNews } from '@/api/partyaffairs/news';
import { allNewsClassify } from '@/api/partyaffairs/news_classify';
import { NewsClassify } from '@/api/partyaffairs/types/news_classify';
import { PageNewsReq, News } from '@/api/partyaffairs/types/news';
