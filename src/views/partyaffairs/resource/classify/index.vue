...
import { ResourceClassify } from '@/api/partyaffairs/types/resource';
import { allResourceClassify, addResourceClassify, deleteResourceClassify, updateResourceClassify } from '@/api/partyaffairs/resource';
