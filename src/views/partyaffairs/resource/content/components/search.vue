<template>
	<a-row v-permission="'partyaffairs:resource:content:query'">
		<a-col :flex="1">
...
import { PageResourceContentReq } from '@/api/partyaffairs/types/resource';
...
const reset = () => {
	form.value = {} as PageResourceContentReq;
};
</script>
