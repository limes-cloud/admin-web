<template>
	<a-row style="align-items: center; margin-bottom: 16px">
		<a-col :span="12">
			<a-space>
				<a-button v-permission="'partyaffairs:public:add'" type="primary" @click="emit('add')">
					<template #icon>
						<icon-plus />
					</template>
					新建公开
				</a-button>
				<a-button v-permission="'partyaffairs:public:classify:query'" type="primary" status="success" @click="emit('showClassify')">
					<template #icon>
						<icon-list />
					</template>
					公开分类
