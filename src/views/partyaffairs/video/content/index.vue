...
import { pageVideoContent, getVideoContent, addVideoContent, deleteVideoContent, updateVideoContent } from '@/api/partyaffairs/video';
import { PageVideoContentReq, VideoContent } from '@/api/partyaffairs/types/video';
