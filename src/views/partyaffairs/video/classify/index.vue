...
import { addVideoClassify, deleteVideoClassify, pageVideoClassify, updateVideoClassify } from '@/api/partyaffairs/video';
import { PageVideoClassifyReq, VideoClassify } from '@/api/partyaffairs/types/video';
