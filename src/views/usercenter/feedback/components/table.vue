<template>
	<div>
		<a-space direction="vertical" fill>
			<a-table
				v-permission="'uc:feedback:query'"
				row-key="id"
				:loading="loading"
				:columns="columns"
				:data="data"
			...
			>
				...
				<template #operations="{ record }">
					<a-space class="cursor-pointer">
						<a-tag v-permission="'uc:feedback:query'" color="arcoblue" @click="handleMore(record)">
							<template #icon><icon-more /></template>
							详情
						</a-tag>

						<a-tag v-permission="'uc:feedback:update'" color="orangered" @click="handleProcessed(record)">
							<template #icon><icon-edit /></template>
							处理
						</a-tag>

						<a-popconfirm content="您确认删除此反馈？" type="warning" @ok="handleDelete(record.id)">
							<a-tag v-permission="'uc:feedback:delete'" color="red">
...
import { Feedback } from '@/api/usercenter/feedback/type';
import { DeleteFeedback, UpdateFeedback } from '@/api/usercenter/feedback/api';
import { Message } from '@arco-design/web-vue';
import { ListChannelType } from '@/api/usercenter/channel/api';
