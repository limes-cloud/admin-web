		...
		>
			...
			<template #operations="{ record }">
				<a-popconfirm content="您确认取消绑定此渠道" type="warning" @ok="deleteUserChannel(record.channelId)">
					<a-tag v-permission="'uc:oauth:delete'" color="red" class="cursor-pointer">
...
import { DeleteOAuth, ListOAuth } from '@/api/usercenter/oauth/api';
import { OAuth, ListOAuthRequest } from '@/api/usercenter/oauth/type';
