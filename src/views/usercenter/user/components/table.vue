	...
	<a-space direction="vertical" fill>
		...
		>
			...
			<template #status="{ record }">
				<a-space>
					<a-switch v-model="record.status" :disabled="!$hasPermission('uc:user:update:status')" type="round" @change="updateStatus(record)">
			...
			<template #operations="{ record }">
				<a-space class="cursor-pointer">
					<a-tag v-permission="'uc:user:more'" color="arcoblue" @click.stop="emit('more', record.id)">
...
import { DeleteUser, UpdateUserStatus } from '@/api/usercenter/user/api';
import { User } from '@/api/usercenter/user/type';
