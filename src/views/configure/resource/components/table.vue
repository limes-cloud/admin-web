		...
		>
			...
			<template #operations="{ record }">
				<a-space class="cursor-pointer">
					<a-tag v-permission="'configure:resource:value'" color="arcoblue" @click="emit('set', record.id)">
					...
					<template v-if="$hasPermission('configure:resource:delete')">
						<a-popconfirm content="您确认删除此资源" type="warning" @ok="emit('delete', record.id)">
							<a-tag color="red">
...
const emit = defineEmits(['delete', 'update', 'add', 'set', 'resetToken', 'queryToken', 'pageChange']);
