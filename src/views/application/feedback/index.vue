<template>
	<div class="container">
		...
		<a-modal v-model:visible="showGroup" title="反馈分类" width="480px" :body-style="{ padding: 0 }" :footer="false">
			<Group />
		</a-modal>
	</div>
</template>
...
import { FeedbackCategory, Feedback, ListFeedbackRequest } from '@/api/application/feedback/type';
import { ListFeedback } from '@/api/application/feedback/api';
